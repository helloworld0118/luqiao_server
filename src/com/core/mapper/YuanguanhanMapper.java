...
public interface YuanguanhanMapper {

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table yuanguanhan
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	@SelectProvider(type = YuanguanhanSqlProvider.class, method = "countByExample")
	long countByExample(YuanguanhanExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table yuanguanhan
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	@DeleteProvider(type = YuanguanhanSqlProvider.class, method = "deleteByExample")
	int deleteByExample(YuanguanhanExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table yuanguanhan
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	@Delete({ "delete from yuanguanhan", "where id = #{id,jdbcType=INTEGER}" })
	 ...
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	@Insert({ "insert into yuanguanhan (id, project, ", "node, childNode, ", "col2, col3, col4, ", "col5, col6, col7, ",
	...
	@InsertProvider(type = YuanguanhanSqlProvider.class, method = "insertSelective")
	int insertSelective(Yuanguanhan record);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table yuanguanhan
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	@SelectProvider(type = YuanguanhanSqlProvider.class, method = "selectByExample")
	...
	List<Yuanguanhan> selectByExample(YuanguanhanExample example);
	...
	@Select({ "select", "id, project, node, childNode, col2, col3, col4, col5, col6, col7, col8, col9, ",
			...
			"col21, col22, col23, col24, col25, col26, create_date, remark", "from yuanguanhan",
	...
	@Results({ @Result(column = "id", property = "id", jdbcType = JdbcType.INTEGER, id = true),
			...
			@Result(column = "create_date", property = "createDate", jdbcType = JdbcType.VARCHAR),
			@Result(column = "remark", property = "remark", jdbcType = JdbcType.VARCHAR) })
	Yuanguanhan selectByPrimaryKey(Integer id);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table yuanguanhan
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	@UpdateProvider(type = YuanguanhanSqlProvider.class, method = "updateByExampleSelective")
	int updateByExampleSelective(@Param("record") Yuanguanhan record, @Param("example") YuanguanhanExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table yuanguanhan
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	@UpdateProvider(type = YuanguanhanSqlProvider.class, method = "updateByExample")
	int updateByExample(@Param("record") Yuanguanhan record, @Param("example") YuanguanhanExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table yuanguanhan
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	@UpdateProvider(type = YuanguanhanSqlProvider.class, method = "updateByPrimaryKeySelective")
	int updateByPrimaryKeySelective(Yuanguanhan record);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table yuanguanhan
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	@Update({ "update yuanguanhan", "set project = #{project,jdbcType=INTEGER},", "node = #{node,jdbcType=INTEGER},",
			...
			"where id = #{id,jdbcType=INTEGER}" })
	int updateByPrimaryKey(Yuanguanhan record);
}