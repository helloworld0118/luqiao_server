...
import com.core.entity.RoleMenuExample.Criteria;
import com.core.entity.RoleMenuExample.Criterion;
...
public class RoleMenuSqlProvider {
    ...
    public String countByExample(RoleMenuExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("role_menu");
    ...
    public String insertSelective(RoleMenu record) {
        ...
        if (record.getMenu() != null) {
            sql.VALUES("menu", "#{menu,jdbcType=INTEGER}");
        }
    ...
    public String selectByExample(RoleMenuExample example) {
        ...
        sql.FROM(Utils.getDatabase()+".role_menu");
        applyWhere(sql, example, false);
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getMenu() != null) {
            sql.SET("menu = #{record.menu,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(RoleMenu record) {
        ...
        if (record.getMenu() != null) {
            sql.SET("menu = #{menu,jdbcType=INTEGER}");
        }
     ...
     * @mbg.generated Wed Dec 13 15:29:38 CST 2017
     */
    protected void applyWhere(SQL sql, RoleMenuExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
