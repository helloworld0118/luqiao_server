...
import com.core.entity.YuanguanhanExample.Criteria;
import com.core.entity.YuanguanhanExample.Criterion;
...
public class YuanguanhanSqlProvider {
	 ...
	 */
	public String countByExample(YuanguanhanExample example) {
		SQL sql = new SQL();
		sql.SELECT("count(*)").FROM("yuanguanhan");
	 ...
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	public String deleteByExample(YuanguanhanExample example) {
		SQL sql = new SQL();
		sql.DELETE_FROM("yuanguanhan");
		applyWhere(sql, example, false);
		return sql.toString();
	}
	 ...
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	public String insertSelective(Yuanguanhan record) {
		SQL sql = new SQL();
		sql.INSERT_INTO(Utils.getDatabase()+".yuanguanhan");
	 ...
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	public String selectByExample(YuanguanhanExample example) {
		SQL sql = new SQL();
		...
		sql.SELECT("remark");
		sql.FROM(Utils.getDatabase()+".yuanguanhan");
		applyWhere(sql, example, false);
	...
	public String updateByExampleSelective(Map<String, Object> parameter) {
		Yuanguanhan record = (Yuanguanhan) parameter.get("record");
		YuanguanhanExample example = (YuanguanhanExample) parameter.get("example");
		SQL sql = new SQL();
		sql.UPDATE("yuanguanhan");
		if (record.getId() != null) {
	...
	public String updateByExample(Map<String, Object> parameter) {
		SQL sql = new SQL();
		sql.UPDATE(Utils.getDatabase()+".yuanguanhan");
		sql.SET("id = #{record.id,jdbcType=INTEGER}");
		sql.SET("project = #{record.project,jdbcType=INTEGER}");
		sql.SET("node = #{record.node,jdbcType=INTEGER}");
		sql.SET("childNode = #{record.childnode,jdbcType=INTEGER}");
	 ...
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	public String updateByPrimaryKeySelective(Yuanguanhan record) {
		SQL sql = new SQL();
		sql.UPDATE(Utils.getDatabase()+".yuanguanhan");
		if (record.getProject() != null) {
	 ...
	 * @mbg.generated  Wed Jan 17 19:31:18 CST 2018
	 */
	protected void applyWhere(SQL sql, YuanguanhanExample example, boolean includeExamplePhrase) {
		if (example == null) {
			return;
		}
		String parmPhrase1;
