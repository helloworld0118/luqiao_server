        ...
        complete :   
            function(XMLHttpRequest, textStatus) {  
                ...
                if (sessionstatus == "timeout") {  
                    ...
                    if(window.confirm('您的会话已经过期，请重新登陆后继续操作！')||true) {  
...
//            var sessionstatus=XMLHttpRequest.getResponseHeader("Content-Type"); //通过XMLHttpRequest取得响应头，sessionstatus，  
//            console.info(sessionstatus);
//            if(sessionstatus=="text/html;charset=utf-8"){   
//            	 console.info("=============over===========");
//                 var yes = confirm('由于您长时间没有操作, session已过期, 请重新登录.');  
//                 if (yes) {  
//                	 if(top.location != location){ 
//                		 top.location.href= "/luqiao/login";
//                	 }   
//                 }  
//            }   
//                
