...
(function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        this.$toolbar.html('');
        if(showdataRangePicker){
            var data_range_html=[];
            data_range_html.push('<div class="input-group col-sm-6" >');
            data_range_html.push('<span class="input-group-addon">');
            data_range_html.push('<i class="icon-calendar bigger-110"></i>');
            data_range_html.push('</span>');
            data_range_html.push('<input class="form-control" type="text" name="daterange" id="id-date-range-picker-1">');
            data_range_html.push('</div>');
            this.$toolbar.append(data_range_html.join(''));
        }
